...
def dataset_processing(train_df: DataFrame, test_df: DataFrame) -> tuple[DataLoader, DataLoader]:
...
def load_flwr_data(partition_id: int, num_partitions: int) -> tuple[DataLoader, DataLoader]:
    """
    ...
    partition: DataFrame = fds.load_partition(partition_id, "train").with_format("pandas")[:]
